...
import Usuarios.Sistema; // Asegúrate de importar correctamente
...
public class MainCreacionLPyActividades {
    public static void main(String[] args) {
        ...
        LearningPath lp1 =c.crearLP("Java Básico", "Aprende los fundamentos de Java", 1, 40, 5, 
                                            new Date(), new Date(), 1, "profesor01", 
                                            "Entender lo básico de Java", 0.0);
        
        LearningPath lp2 = c.crearLP("Java Avanzado", "Conceptos avanzados de Java", 3, 80, 4, 
                                            new Date(), new Date(), 1, "profesor02", 
                                            "Dominar conceptos avanzados de Java", 0.0);
    
        try {
            // Crear actividad y agregarla al LearningPath
            Actividad act1 =  t.crearTarea("Video variables 1", "Introducir variables", "NombreActividad", 
                    new Date(), new Date(), 120, 3, 4.5, 
                    "Recurso Educativo", true, "Java Básico"); 
            Quiz act2 =  q.crearQuiz("Quiz de transformaciones lineales", "aprender a ....", "Quiz 2", 
                    new Date(), new Date(), 120, 3, 4.5, 
                    "Recurso Educativo", true, "Java Básico", 10); 
