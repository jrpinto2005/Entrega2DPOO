...
public class EnvioExamen extends Envio
{
	...
	public EnvioExamen(Actividad actividad, String idEstudiante, String tituloLP, boolean completado, double puntaje, int puntajeMaximo, double notaPorcentaje, List<RespuestaAbierta> respuestas) {
